...
export const events = sqliteTable("events", {
  ...
  offerTerms: text("offer_terms").notNull().default(""),
  ...
  unlimitedCapacity: integer("unlimited_capacity", { mode: "boolean" }).notNull().default(false),
  attendanceType: text("attendance_type").notNull().default(""),
  maxGuests: integer("max_guests").notNull().default(0),
  allowGuestNames: integer("allow_guest_names", { mode: "boolean" }).notNull().default(false),
  registrationOpensAt: integer("registration_opens_at"),
  registrationClosesAt: integer("registration_closes_at"),
  registrationOpensDate: text("registration_opens_date").notNull().default(""),
  registrationOpensTime: text("registration_opens_time").notNull().default(""),
  registrationClosesDate: text("registration_closes_date").notNull().default(""),
  registrationClosesTime: text("registration_closes_time").notNull().default(""),
  ...
  appointmentRecommended: integer("appointment_recommended", { mode: "boolean" }).notNull().default(false),
  costType: text("cost_type").notNull().default(""),
  costLabel: text("cost_label").notNull().default(""),
  ctaLabel: text("cta_label").notNull().default(""),
  ctaAction: text("cta_action").notNull().default(""),
  ctaUrl: text("cta_url").notNull().default(""),
  ctaEmail: text("cta_email").notNull().default(""),
  ctaPhone: text("cta_phone").notNull().default(""),
  sharingEnabled: integer("sharing_enabled", { mode: "boolean" }).notNull().default(true),
  shareMessage: text("share_message").notNull().default(""),
