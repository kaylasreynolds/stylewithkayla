...
function parseEventShape(value:Record<string,unknown>,partial=false,publishFormats=false){rejectUnexpectedKeys(value,EVENT_KEYS);const o:EventInput={};const take=(k:string,fn:(v:unknown)=>unknown,def?:unknown)=>{if(k in value)o[k]=fn(value[k]);else if(!partial&&def!==undefined)o[k]=def;};
  take("title",v=>str(v,"title",160),"");take("eventLabel",v=>v===""?"":enumValue(v,"eventLabel",[...eventLabels,...legacyEventLabels]),"");take("customLabel",v=>str(v,"customLabel",80),"");take("shortDescription",v=>str(v,"shortDescription",320),"");take("description",v=>str(v,"description",5000),"");take("offer",v=>str(v,"offer",180),"");take("offerDetails",v=>str(v,"offerDetails",1000),"");take("offerTerms",v=>str(v,"offerTerms",1000),"");
