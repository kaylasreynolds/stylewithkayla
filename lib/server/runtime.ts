...
type RuntimeEnv = { DB?: D1Database; ADMIN_EMAILS?: string; MAINTENANCE_SECRET?: string };
...
export function getMaintenanceSecret() { return (env as unknown as RuntimeEnv).MAINTENANCE_SECRET?.trim() ?? ""; }
