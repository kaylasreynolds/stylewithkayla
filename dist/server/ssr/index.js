...
var client_references_default = {
	"009ec46bb0c1": async () => {
		const m = await import("./assets/AdminDashboard-B2-4Tqyb.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-DrbESFCE.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"4087ee207052": async () => {
		const m = await import("./assets/AdminAvailability-DvjO7c64.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-B2CgV5Fc.js");
		return {
			get "ErrorBoundary"() {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-yhpkORGx.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"7ec147572b06": async () => {
		const m = await import("./assets/AdminPrivacy-f-UJD-aE.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"b68f4ee01005": async () => {
		const m = await import("./assets/page-DkNNQETW.js");
		return {
			get "ClientActionClient"() {
				return m["ClientActionClient"];
			},
			get "default"() {
				return m["default"];
			}
	...
	"fc858ccfd676": async () => {
		const m = await import("./assets/page-DCiTaf0t.js");
		return {
			get "StyleProfileClient"() {
				return m["StyleProfileClient"];
			},
			get "default"() {
				return m["default"];
			}
