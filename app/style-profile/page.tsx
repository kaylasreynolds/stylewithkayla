        ...
        <section className="profile-workspace">
          ...
          {step === 3 && <div className="profile-step">
            ...
            <Question title="How do you usually like your tops to fit?">
              <div className="fit-question-layout"><div className="fit-image-space" aria-label="Reserved space for a top-fit reference image"><span>Top fit reference image</span></div><div className="answer-chips">{["More fitted", "Relaxed", "Oversized", "No preference"].map((option) => <button key={option}>{option}</button>)}</div></div>
            </Question>
