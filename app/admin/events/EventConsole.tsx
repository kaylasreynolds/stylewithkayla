...
<fieldset>
  ...
  <div className="event-preview-layout">
    <div className="event-public-preview"><PublicEventCard event={form} previewImage={localPreview||asset?.previewUrl}/></div>
