...
export function columns(
  ...
  const map: Record<string, string> = {
    ...
    allowGuestNames: "allow_guest_names",
    registrationOpensDate: "registration_opens_date",
    registrationOpensTime: "registration_opens_time",
    registrationClosesDate: "registration_closes_date",
    registrationClosesTime: "registration_closes_time",
    allowDuplicateRegistration: "allow_duplicate_registration",
    appointmentRequired: "appointment_required",
    appointmentRecommended: "appointment_recommended",
    costType: "cost_type",
  ...
  values.push(
    times.startsAt,
    times.endsAt,
    times.registrationOpensAt,
    times.registrationClosesAt,
